          ...
          <div class="col-12">
            ...
            <div class="card card-table-border-none" id="recent-orders">
              <div class="card-header justify-content-between pt-2 pb-2 heading-border-bottom">
                <h2>Gallery
                <button data-url="gallery/addGalleryModal" type="button" class="btn ml-2 btn-info btn-pill loadModal">
              ...
              <div class="card-body pt-0 pb-5">
                <table class="table card-table table-responsive table-responsive-large" style="width:100%">
                  ...
                  <tbody>
                    <?php foreach ($gallery_details as $key => $gallery_detail) { ?>
                    <tr class="card-header-top">
                      <td ><?php echo ($key + 1);?></td>
                      <td ><?php echo $gallery_detail['name'];?></td>
                      <td><?php echo ($gallery_detail['desc']) ? $gallery_detail['desc'] : "-";?></td>
                      <td>
                        ...
                        <div class="dropdown show d-inline-block widget-dropdown">
                          ...
                          <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-recent-order1">
                            <li class="dropdown-item">
                              <a data-url="gallery/addGalleryModal" data-id="<?php echo $gallery_detail['id'];?>" class="editBtn btn">Edit</a>
                            </li>
                            <li class="dropdown-item">
